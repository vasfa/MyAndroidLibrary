...
public class RecyclerViewCenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_view_center);
        Initialize();
    }
    ...
    private void Initialize() {
        try{
            ...
            gl_manager=new GridLayoutManager(RecyclerViewCenterActivity.this,1, LinearLayoutManager.HORIZONTAL,false);
//            rv_content.setLayoutManager(gl_manager);
//            rv_content.setLayoutManager(new CenterLayoutManager(RecyclerViewCenterActivity.this));
            rv_content.setLayoutManager(new CenterLayoutManager(RecyclerViewCenterActivity.this,1, LinearLayoutManager.HORIZONTAL,true));

            adapter = new Adapter_RecyclerviewStyle5(RecyclerViewCenterActivity.this,
                    (Activity) RecyclerViewCenterActivity.this,
                    1,
                    rv_content);
