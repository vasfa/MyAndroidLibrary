...
import Adapter.Adapter_RecyclerviewStyle4;

public class RecyclerViewSwitchingTopToBottomActivity extends AppCompatActivity {

    RecyclerView rv_content;
    LinearLayoutManager mLayoutManager;
    Adapter_RecyclerviewStyle4 adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycler_view_switching_top_to_bottom);
        Initialize();
    }
    ...
    private void Initialize() {
        try {
            ...
            adapter = new Adapter_RecyclerviewStyle4(RecyclerViewSwitchingTopToBottomActivity.this,
                    (Activity) RecyclerViewSwitchingTopToBottomActivity.this,
                    1,
                    rv_content,
                    RecyclerViewSwitchingTopToBottomActivity.this);
