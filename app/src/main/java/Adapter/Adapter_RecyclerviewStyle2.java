...
import ir.mlibs.notificationlibrary.RecyclerViewBottomToTopActivity;
...
public class Adapter_RecyclerviewStyle2 extends RecyclerView.Adapter {
    ...
    Activity m_activity;
    private int type = 1;
    RecyclerViewBottomToTopActivity recyclerViewBottomToTopActivity;

    public Adapter_RecyclerviewStyle2(Context context,
        ...
        m_context = context;
        m_activity = activity;
        this.recyclerViewBottomToTopActivity=recyclerViewBottomToTopActivity;
...
//    }
    ...
    public int getItemViewType(int position) {
        ...
        newpos = position + 1;
        int a = 1 != newpos ? VIEW_ITEM : VIEW_PROG;
        if (!progressstop)
            a = 1;
        if(Utilitis.NameList.size()<15)
            a=1;
//        String asd="0";
//        if(a==0)
//            asd="0";
