...
import ir.mlibs.notificationlibrary.RecyclerViewSwitchingBottmToTopActivity;
...
public class Adapter_RecyclerviewStyle3 extends RecyclerView.Adapter {
    ...
    Activity m_activity;
    private int type = 1;
    RecyclerViewSwitchingBottmToTopActivity recyclerViewActivity;

    public Adapter_RecyclerviewStyle3(Context context,
...
//    }
    ...
    public int getItemViewType(int position) {
        ...
        newpos = position + 1;
        int a = 1 != newpos ? Utilitis.SwitchTypes.get(position) : VIEW_PROG;
        if (!progressstop)
            a = Utilitis.SwitchTypes.get(position);;
