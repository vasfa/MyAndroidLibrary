...
import ir.mlibs.notificationlibrary.RecyclerViewActivity;
import ir.mlibs.notificationlibrary.Utilitis;

/**
 * Created by vali on 2018-04-07.
 */

public class Adapter_RecyclerviewStyle1 extends RecyclerView.Adapter {
    ...
    public Adapter_RecyclerviewStyle1(Context context,
        ...
        if (viewType == 1) {
            View v =
                    LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.single_row_style1, parent, false);
