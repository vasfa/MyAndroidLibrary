...
import ir.mlibs.sliderfragmentgallery.TouchImageViewFragment;
...
public class MyProgressTarget<Z> extends ProgressTarget<String, Z> {
    ...
    private TouchImageViewFragment image2;
    ...
    public MyProgressTarget(Target<Bitmap> target, ProgressBar progress, TouchImageViewFragment image2, TextView text, AVLoadingIndicatorView avLoadingIndicatorView) {
        super((Target<Z>) target);
        this.progress = progress;
        this.image2 = image2;
        this.text = text;
    ...
    public void onProgress(long bytesRead, long expectedLength) {
        ...
        if (image2 != null)
            image2.setImageLevel((int) (10000 * bytesRead / expectedLength));
