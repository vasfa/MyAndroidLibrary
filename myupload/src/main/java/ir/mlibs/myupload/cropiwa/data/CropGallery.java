package ir.mlibs.myupload.cropiwa.data;
...
import ir.mlibs.myupload.R;
import ir.mlibs.myupload.cropiwa.App;
...
public class CropGallery {
    ...
    public static Uri createNewEmptyFile() {
        ...
        Uri uri=null;
        try{
            uri=Uri.fromFile(new File(App.getInstance().getFilesDir(),System.currentTimeMillis() + ".png"));
        }catch (Exception ex)
        {
            String asd="";
        }
